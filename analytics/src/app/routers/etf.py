...
from app.crud import get_etf, get_all_etf_symbols, get_etf_statistics
...
async def get_etf_daily_stats(etf_id: str, requested_date: str, db: Session = Depends(get_db)):
